...
import Select from 'react-select'; // <-- Importado o React Select
...
const Exterminate = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            setValue('document', '');  // Limpa o campo de código após sucesso
    ...
    // Formata as palestras para o formato padrão do react-select ({ value, label })
